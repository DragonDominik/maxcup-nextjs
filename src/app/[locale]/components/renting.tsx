...
export default function Renting() {
    ...
    return (
        <>
            <USALProvider>
                <div id="renting" className="flex justify-center items-center relative w-full min-h-[100vh] 2xl:min-h-[60vw] h-fit max-h-[2000px] md:max-h-[160vw] lg:max-h-[80vw] m-0 p-0 mt-20 lg:mt-0 overflow-hidden">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-1 mx-auto">
                            ...
                            <div className="flex flex-col justify-start p-1 order-4 lg:order-4 items-center 2xl:items-start">
                                <div className="inline-block">
                                    <Image
                                        src="/img/maxcup-repohar-berles.webp"
                                        alt={t("title")}
