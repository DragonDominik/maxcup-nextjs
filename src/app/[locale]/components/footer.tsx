                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0 w-full flex-1" data-usal="fade-u delay-300 threshold-10 duration-800">
                            ...
                            <div className="py-4 flex flex-col items-center justify-start order-1 md:order-1 lg:order-2">
                                ...
                                <div className="flex gap-4 md:gap-2 mt-2">
                                    ...
                                    {/* Instagram */}
                                    <a href="https://www.instagram.com/maxcuphungary?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" className="text-[var(--light-blue)] hover:scale-125 transition-transform">
                                        <svg viewBox="0 0 512 512" className="w-7 h-7 md:w-5 md:h-5 fill-current">
                                    ...
                                    {/* Tiktok */}
                                    <a href="https://www.tiktok.com/@maxcuphungary?is_from_webapp=1&sender_device=pc" target="_blank" className="text-[var(--light-blue)] hover:scale-125 transition-transform">
