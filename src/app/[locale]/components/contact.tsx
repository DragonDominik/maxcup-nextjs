                                ...
                                <div className="space-y-2" data-usal="once fade-r threshold-80 delay-100 duration-800">
                                    ...
                                    <div className="flex flex-col items-start space-x-2">
                                        ...
                                        <div className="flex gap-4 md:gap-2">
                                            ...
                                            {/* Instagram */}
                                            <a href="https://www.instagram.com/maxcuphungary" target="_blank" className="text-[var(--dark-blue)] hover:scale-125 transition-transform">
                                                <svg viewBox="0 0 512 512" className="w-7 h-7 md:w-5 md:h-5 fill-current">
                                            ...
                                            {/* Tiktok */}
                                            <a href="https://www.tiktok.com/@maxcuphungary" target="_blank" className="text-[var(--dark-blue)] hover:scale-125 transition-transform">
