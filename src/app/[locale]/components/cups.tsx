            ...
            <USALProvider>
                <div id="cups" className="flex flex-col justify-center items-center relative w-full min-h-[100vh] 2xl:min-h-[60vw] h-fit max-h-[1000px] md:max-h-[160vw] lg:max-h-[80vw] m-0 p-0">
                    <div className="w-[90%] lg:w-[85%] mb-4">
                        ...
                        <p className="whitespace-pre-wrap text-justify" data-usal="once ease-in-out duration-500 threshold-70">
                            {t("description")}
                        </p>
                    </div>
                    {/* Kép loop */}
                    <div className="grid grid-cols-[auto_1fr_auto] items-center w-[90%] lg:w-[85%] mb-8 gap-0" data-usal="once ease-in-out duration-500 threshold-70">
